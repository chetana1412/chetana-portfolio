...
const Hero = () => {
  ...
  useEffect(() => {
    init(textRef.current, {
      showCursor: true,
      strings: ["Creative Artist", "Software Developer", "Tech Enthusiast"],
    });
  }, []);

  return (
    <section className="relative w-full min-h-screen mx-auto flex flex-col justify-start items-center pt-10 sm:pt-20">
  {/* Text + Links */}
  <div
  ...
  >
    ...
    <div className="head2">
      <h1 className={`${styles.heroHeadText} text-white`}>
        Hi there, I'm{" "}
        <p className="name text-[#915EFF]">Chetana G Badiger</p>
      </h1>
      <h3>
        <span
          ref={textRef}
      ...
      <div className="flex gap-6 mt-4">
        <a
          href="https://github.com/chetanagbadiger"
          target="_blank"
